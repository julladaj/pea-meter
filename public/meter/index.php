									...
									<?php if (isset($_POST['search']) && $_POST['search']) { ?>
										<form method="POST" action="" enctype="multipart/form-data">
											<div class="input-group">
												<input type="text" class="form-control" name="search" placeholder="ค้นหาจากเลขคำร้อง หรือเบอร์โทร หรือหมายเลขผู้ใช้ไฟ หรือชื่อ-สกุล" value="<?php echo (isset($_POST['search']) && $_POST['search'])? $_POST['search'] : ""; ?>" />
										...
										<div class="form-group row">
											...
											<div class="col-xl-11 col-lg-10 col-md-10 col-sm-8">
												<span style="font-size:14pt;font-weight:700;"><?php echo $result['auto_id']; ?></span>
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-xl-3 col-lg-4 col-md-10 col-sm-8">
												<input type="text" class="form-control" name="fname" value="<?php echo (isset($result['fname']))? $result['fname'] : ''; ?>" readonly />
											</div>
											<label for="example-search-input" class="col-xl-1 col-lg-2 col-md-2 col-sm-4 col-form-label">วันที่ยื่นคำร้อง:</label>
											<div class="col-xl-3 col-lg-4 col-md-10 col-sm-8">
												<input type="text" class="form-control" name="date_add" value="<?php echo (isset($result['date_add']))? date_thai_format($result['date_add']) : ''; ?>" readonly />
											</div>
											<!--<label for="example-search-input" class="col-xl-1 col-lg-2 col-md-2 col-sm-4 col-form-label">หมายเลขผู้ใช้ไฟฟ้า:</label>
											<div class="col-xl-3 col-lg-4 col-md-10 col-sm-8">
												<input type="text" class="form-control" name="number1" value="<?php echo (isset($result['number1']))? $result['number1'] : ''; ?>" />
											</div>-->
											<label for="example-search-input" class="col-xl-1 col-lg-2 col-md-2 col-sm-4 col-form-label">ประเภทคำร้อง:</label>
											<div class="col-xl-3 col-lg-4 col-md-10 col-sm-8">
												<input type="text" class="form-control" name="meter_category_id" value="<?php echo (isset($result['meter_category_detail']))? $result['meter_category_detail'] : ''; ?>" readonly />
											</div>
											<label for="example-search-input" class="col-xl-1 col-lg-2 col-md-2 col-sm-4 col-form-label">ขนาดมิเตอร์:</label>
											<div class="col-xl-3 col-lg-4 col-md-10 col-sm-8">
												<input type="text" class="form-control" name="meter_size_detail" value="<?php echo (isset($result['meter_size_detail']))? $result['meter_size_detail'] : ''; ?>" readonly />
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-xl-3 col-lg-4 col-md-10 col-sm-8">
												<input type="text" class="form-control" name="recipient_name" value="<?php echo (isset($result['recipient_name']))? $result['recipient_name'] : ''; ?>" readonly />
											</div>
											<label for="example-search-input" class="col-xl-1 col-lg-2 col-md-2 col-sm-4 col-form-label">วันนัดตรวจ:</label>
											<div class="col-xl-3 col-lg-4 col-md-10 col-sm-8">
												<input type="text" class="form-control" name="date_appoint" value="<?php echo (isset($result['date_appoint']))? date_thai_format($result['date_appoint']) : ''; ?>" readonly />
											</div>
											<label for="example-search-input" class="col-xl-1 col-lg-2 col-md-2 col-sm-4 col-form-label">ชื่อผู้ตรวจ:</label>
											<div class="col-xl-3 col-lg-4 col-md-10 col-sm-8">
												<input type="text" class="form-control" name="officer_name" value="<?php echo (isset($result['officer_name']))? $result['officer_name'] : ''; ?>" readonly />
											</div>
											<label for="example-search-input" class="col-xl-1 col-lg-2 col-md-2 col-sm-4 col-form-label">ผลการตรวจ:</label>
											<div class="col-xl-3 col-lg-4 col-md-10 col-sm-8">
												<input type="text" class="form-control" name="meter_qc_detail" value="<?php echo (isset($result['meter_qc_detail']))? $result['meter_qc_detail'] : ''; ?>" readonly />
											</div>
											<label for="example-search-input" class="col-xl-1 col-lg-2 col-md-2 col-sm-4 col-form-label">วันที่ชำระเงินค่ามิเตอร์:</label>
											<div class="col-xl-3 col-lg-4 col-md-10 col-sm-8">
												<input type="text" class="form-control" name="date_payment" value="<?php echo (isset($result['date_payment']))? date_thai_format($result['date_payment']) : ''; ?>" readonly />
											</div>
											<label for="example-search-input" class="col-xl-1 col-lg-2 col-md-2 col-sm-4 col-form-label">วันส่งงานติดตั้ง:</label>
											<div class="col-xl-3 col-lg-4 col-md-10 col-sm-8">
												<input type="text" class="form-control" name="date_install" value="<?php echo (isset($result['date_install']))? date_thai_format($result['date_install']) : ''; ?>" readonly />
											</div>
										</div>

<?php if (ENABLE_SLIPT_UPLOAD && isset($result['payment_value']) && $result['payment_value'] > 0 && isset($result['meter_qc_detail']) && $result['meter_qc_detail'] == 'รอชำระค่าธรรมเนียม') { ?>
										<div class="form-group row">
											<label for="example-search-input" class="col-xl-1 col-lg-2 col-md-2 col-sm-4 col-form-label" style="color: red;">บัญชี:</label>
											<div class="col-xl-3 col-lg-4 col-md-10 col-sm-8">
												<input type="text" class="form-control" style="font-weight: 900;" name="payment_value" value="<?php echo BANK_NAME; ?>" readonly />
											</div>
											<label for="example-search-input" class="col-xl-1 col-lg-2 col-md-2 col-sm-4 col-form-label" style="color: red;">ชื่อบัญชี:</label>
											<div class="col-xl-3 col-lg-4 col-md-10 col-sm-8">
												<input type="text" class="form-control" style="font-weight: 900;" value="<?php echo ACCOUNT_NAME; ?>" readonly />
											</div>
											...
											<div class="col-xl-3 col-lg-4 col-md-10 col-sm-8">
												<input type="text" class="form-control" style="font-weight: 900;" value="<?php echo ACCOUNT_NO; ?>" readonly />
											</div>
											...
											<div class="col-xl-3 col-lg-4 col-md-10 col-sm-8">
												<input type="text" class="form-control" style="font-weight: 900;" name="payment_value" value="<?php echo $result['payment_value']; ?>" readonly />
											</div>
										</div>
										<div class="form-group row">
											...
											<div class="col-xl-1 col-lg-3">
												<div class="kt-avatar kt-avatar--outline" id="kt_user_avatar_1">
													<div class="kt-avatar__holder" id="silpt_display" style="background-image: url(<?php echo ($uploaded_image_path)? $url_name : 'assets/media/users/default.jpg';?>)"></div>
...
<?php } ?>
										<div class="form-group row">
											...
											<div class="col-xl-11 col-lg-10 col-md-10 col-sm-8">
												<input type="text" class="form-control " name="cause" value="<?php echo (isset($result['cause']))? $result['cause'] : ''; ?>" data-toggle="kt-tooltip" data-placement="top" data-html="true" title="<b>สาเหตุ</b> ที่เจ้าพนักงานระบุให้แก่ผู้ใช้ไฟ" />
											</div>
											<label for="example-search-input" class="col-xl-1 col-lg-2 col-md-2 col-sm-4 col-form-label">ขยายเขต:</label>
											<div class="col-xl-11 col-lg-10 col-md-10 col-sm-8">
												<input type="text" class="form-control" name="cause1" value="<?php echo (isset($result['cause1']))? $result['cause1'] : ''; ?>" />
											</div>
										</div>
										
<?php if (isset($result['meter_qc_detail']) && ($result['meter_qc_detail'] == 'ไม่ผ่าน' || $result['meter_qc_detail'] == 'รอนัด')) { ?>
										<div class="form-group row">
											...
											<div class="col-xl-2 col-lg-3 col-md-6 col-sm-6">
												<button class="form-control <?php echo (isset($result['request_button']) && $result['request_button'] == 1)? 'btn-warning' : ''; ?>" style="font-weight: 900;" id="button_recheck_request" <?php echo (isset($result['request_button']) && $result['request_button'] == 1)? '' : 'disabled'; ?>><i class="flaticon-alert"></i> ขอนัดตรวจใหม่</button>
											</div>
										</div>
<?php } ?>
										...
										<div class="form-group row">
											...
											<div class="col-xl-3 col-lg-4 col-md-10 col-sm-8">
												<input type="text" class="form-control" name="date_deathline" value="<?php echo (isset($result['date_deathline']))? $result['date_deathline'] : ''; ?>" />
											</div>
											<label for="example-search-input" class="col-xl-1 col-lg-2 col-md-2 col-sm-4 col-form-label">หมายเลขเครื่องวัด:</label>
											<div class="col-xl-3 col-lg-4 col-md-10 col-sm-8">
												<input type="text" class="form-control" name="number2" value="<?php echo (isset($result['number2']))? $result['number2'] : ''; ?>" />
											</div>
											<label for="example-search-input" class="col-xl-1 col-lg-2 col-md-2 col-sm-4 col-form-label">วันที่ติดตั้ง แล้วเสร็จ:</label>
											<div class="col-xl-3 col-lg-4 col-md-10 col-sm-8">
												<input type="text" class="form-control" name="date_finish" value="<?php echo (isset($result['date_finish']))? $result['date_finish'] : ''; ?>" />
											</div>
										</div>
										<?php } else { ?>
										<div class="container">
											<div class="center">
												...
												<h3 style="font-size: 1.5rem;padding-top: 30px;"><?php echo PEANAME; ?><br /></h3>
											...
											<div class="kt-grid__item">
												...
												<div class="kt-wizard-v1__nav">
													...
													<div class="kt-wizard-v1__nav-items kt-wizard-v1__nav-items--clickable">
														<div class="kt-wizard-v1__nav-item" data-ktwizard-type="step" <?php echo (isset($result['date_add']) && $result['date_add'])? 'data-ktwizard-state="done"' : ''; ?>>
															<div class="kt-wizard-v1__nav-body">
																<div class="kt-wizard-v1__nav-icon">
																	<i class="flaticon-notes"></i>
																</div>
																<div class="kt-wizard-v1__nav-label">
																	1. เริ่มต้นรับคำร้อง<br><small><?php echo (isset($result['date_add']) && $result['date_add'])? $result['date_add'] : '( รอดำเนินการ )'; ?></small>
																</div>
															</div>
														</div>
														<div class="kt-wizard-v1__nav-item" data-ktwizard-type="step" <?php echo (isset($result['date_appoint']) && $result['date_appoint'])? 'data-ktwizard-state="done"' : ''; ?>>
															<div class="kt-wizard-v1__nav-body">
																<div class="kt-wizard-v1__nav-icon">
																	<i class="flaticon-list"></i>
																</div>
																<div class="kt-wizard-v1__nav-label">
																	2. ผลการตรวจ<br><small><?php echo (isset($result['meter_qc_detail']) && $result['meter_qc_detail'])? $result['meter_qc_detail'] : '( รอดำเนินการ )'; ?></small>
																</div>
															</div>
														</div>
														<div class="kt-wizard-v1__nav-item" data-ktwizard-type="step" <?php echo (isset($result['date_payment']) && $result['date_payment'])? 'data-ktwizard-state="done"' : ''; ?>>
															<div class="kt-wizard-v1__nav-body">
																<div class="kt-wizard-v1__nav-icon">
																	<i class="flaticon2-list"></i>
																</div>
																<div class="kt-wizard-v1__nav-label">
																	3. ชำระค่ามิเตอร์<br><small><?php echo (isset($result['date_payment']) && $result['date_payment'])? $result['date_payment'] : '( รอดำเนินการ )'; ?></small>
																</div>
															</div>
														</div>
														<div class="kt-wizard-v1__nav-item" data-ktwizard-type="step" <?php echo (isset($result['date_deathline']) && $result['date_deathline'])? 'data-ktwizard-state="done"' : ''; ?>>
															<div class="kt-wizard-v1__nav-body">
																<div class="kt-wizard-v1__nav-icon">
																	<i class="flaticon-truck"></i>
																</div>
																<div class="kt-wizard-v1__nav-label">
																	4. กำหนดวันติดตั้ง<br><small><?php echo (isset($result['date_deathline']) && $result['date_deathline'])? $result['date_deathline'] : '( รอดำเนินการ )'; ?></small>
																</div>
															</div>
														</div>
														<div class="kt-wizard-v1__nav-item" data-ktwizard-type="step" <?php echo (isset($result['date_finish']) && $result['date_finish'])? 'data-ktwizard-state="done"' : ''; ?>>
															<div class="kt-wizard-v1__nav-body">
																<div class="kt-wizard-v1__nav-icon">
																	<i class="flaticon-globe"></i>
																</div>
																<div class="kt-wizard-v1__nav-label">
																	5. ติดตั้งแล้วเสร็จ<br><small><?php echo (isset($result['date_finish']) && $result['date_finish'])? $result['date_finish'] : '( รอดำเนินการ )'; ?></small>
																</div>
															</div>
														</div>
													</div>
